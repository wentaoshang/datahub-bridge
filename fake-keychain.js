...
var identityStorage = new ndn.MemoryIdentityStorage();
var privateKeyStorage = new ndn.MemoryPrivateKeyStorage();
var keyChain = new ndn.KeyChain
  (new ndn.IdentityManager(identityStorage, privateKeyStorage),
   new ndn.SelfVerifyPolicyManager(identityStorage));

var keyName = new ndn.Name("/test/bms/repo/key/DSK-123");
var certificateName = keyName.getSubName(0, keyName.size() - 1).append
  ("KEY").append(keyName.get(-1)).append("ID-CERT").append("0");
identityStorage.addKey(keyName, ndn.KeyType.RSA, new ndn.Blob(DEFAULT_RSA_PUBLIC_KEY_DER, false));
privateKeyStorage.setKeyPairForKeyName
(keyName, ndn.KeyType.RSA, DEFAULT_RSA_PUBLIC_KEY_DER, DEFAULT_RSA_PRIVATE_KEY_DER);

exports.keyChain = keyChain;
exports.certificateName = certificateName;
